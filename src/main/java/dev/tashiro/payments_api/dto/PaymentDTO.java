...
public record PaymentDTO(@NotNull(message = "Deve conter código de débito") int debitCode,
        ...
        @NotBlank(message = "Deve conter método de pagamento") @Size(max = 14, message = "Método de pagamento deve ter no máximo 14 caracteres") @Pattern(regexp = "^(boleto|pix|cartao_credito|cartao_debito)$", message = "Método de pagamento inválido") String paymentMethod,
